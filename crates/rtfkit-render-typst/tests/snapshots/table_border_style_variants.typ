...
#table(
  columns: (1in, 1in, 1in),
  rows: auto,
  table.cell(stroke: (top: (paint: black, thickness: 2.0pt, cap: "butt", dash: (2.0pt, 2.4pt))), [Dotted]),
  table.cell(stroke: (top: 0.7pt + black), [#box(width: 100%, stroke: (top: 0.7pt + black), inset: (top: 1.3pt), outset: (top: 3.7pt))[Double]]),
  table.cell(stroke: (top: (paint: black, thickness: 2.0pt, cap: "butt", dash: (8.0pt, 4.0pt))), [Dashed])
)